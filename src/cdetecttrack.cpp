...
void CDetectTrack::detectAndDraw(cv::Mat& img,double scale, bool tryflip )
{
       ...
       // printf( "detection time = %g ms\n", t/((double)cvGetTickFrequency()*1000.) );
        qDebug()<<"faces num is "<<faces.size();
        qDebug()<<"faces2 num is "<<faces2.size();
...
bool CDetectTrack::detectAndDraw(cv::Mat& img,double scale, bool tryflip,cv::Rect& roi)
{
        int i = 0;
        double t = 0;
        vector<Rect> faces, faces2;
