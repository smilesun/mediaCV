...
CImgController::CImgController()
{
}

void CImgController::getColorRange()
{
...
void CImgController::convert_video(char* infilename,char* outfilename)
{
...
void CImgController::salt(cv::Mat &image,int n)
{
    for(int k=0;k<n;k++)
      {
...
void CImgController::sharpen(const cv::Mat &image, cv::Mat &result)//laplasian
